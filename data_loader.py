...
def get_live_data():
    ...
    """
    with st.spinner("Fetching and processing live climate and geo data... This may take several minutes..."):
        # --- Load Geospatial Data ---
        geo_file_path = os.path.join(os.path.dirname(__file__), 'counties.geojson')
        if not os.path.exists(geo_file_path):
            st.error("Fatal Error: The GeoJSON file for county boundaries was not found.")
