...
def combine_climate_data():
    ...
    spi_path = os.path.join(
        ...
        "index",
        "output",
        "CDC_StandardizedPrecipitationIndex_output.csv",
    )
    pdsi_path = os.path.join(
        script_dir,
        "..",
        "palmer_drought",
        "output",
        "CDC_PalmerDroughtSeverityIndex_output.csv",
    )
    spei_path = os.path.join(
        script_dir,
        "..",
        "evapotranspiration_index",
        "output",
        "CDC_StandardizedPrecipitationEvapotranspirationIndex_output.csv",
    )
    ...
    spei_df["index_type"] = variable_mapping[
